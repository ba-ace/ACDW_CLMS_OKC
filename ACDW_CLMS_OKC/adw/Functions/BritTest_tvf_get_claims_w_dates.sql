...
CREATE FUNCTION [adw].[BritTest_tvf_get_claims_w_dates]
...
(
    ...
    (
      --------------------------------------------------
        ...
        ) L11 ON L11.VALUE_CODE = C1.ProcCode --27550
        ...
        ) L22 ON L22.VALUE_CODE = C2.DRG_CODE--0
        ...
        ) L33 ON L33.VALUE_CODE = C3.DIAGCODE --0
        ...
        ) L44 ON cast(L44.VALUE_CODE as int) = cast(C4.REVENUE_CODE as int)--0
        ...
        ) L55 ON L55.VALUE_CODE = C5.NDC_CODE--0
        ...
        ) L66 ON L66.VALUE_CODE = C6.PROCEDURE_CODE --19147 union = 46697 select 19147 + 27550
