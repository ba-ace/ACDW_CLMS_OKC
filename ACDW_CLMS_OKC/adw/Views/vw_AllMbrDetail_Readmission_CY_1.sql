...
AS
     ...
     (
         SELECT b.*
         FROM adw.[tvf_get_claims_w_dates]('Inpatient Stay', '', '', '01/01/2018', '01/01/2019') a
              JOIN adw.[tvf_get_claims_w_dates]('Inpatient Stay', '', '', '01/01/2018', '01/01/2019') b ON a.seq_claim_id <> b.seq_claim_id
